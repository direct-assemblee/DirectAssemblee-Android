...
data class Rate(val group: RateGroup? = null, val activityRate: Int = -1) : Parcelable {
    ...
    constructor(parcel: Parcel) : this(
            parcel.readParcelable(RateGroup::class.java.classLoader),
            parcel.readInt())
    ...
    companion object {
        @JvmField
        val CREATOR = parcelableCreator(::Rate)
    }
