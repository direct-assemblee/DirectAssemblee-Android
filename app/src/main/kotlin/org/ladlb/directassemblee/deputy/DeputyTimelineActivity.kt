...
class DeputyTimelineActivity : AbstractToolBarActivity(), DeputyTimeLineFragmentListener {
    ...
    companion object Factory {
        ...
        fun getIntent(context: Context, deputy: Deputy): Intent {
            ...
            val intent = Intent(context, DeputyTimelineActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.beginTransaction().replace(
                R.id.frameLayout,
                DeputyTimelineFragment.newInstance(
