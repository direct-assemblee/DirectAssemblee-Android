...
class AddressAdapter(items: ArrayList<org.ladlb.directassemblee.model.Address>) : PlaceholderAdapter<org.ladlb.directassemblee.model.Address>(items) {
    ...
    private fun onBindItem(holder: ViewHolder) {
        ...
        view.setOnClickListener {
            listener?.onAddressClicked(it.tag as org.ladlb.directassemblee.model.Address)
        }
